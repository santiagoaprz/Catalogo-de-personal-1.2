...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $numero_empleado = mysqli_real_escape_string($conn, $_POST['numero_empleado']);
    ...
    mysqli_stmt_bind_param($stmt, 'ssssss', $numero_empleado, $nombre, $puesto, $departamento, $dire_fisica, $telefono);
